...
%Redefincion del plain
\makeatletter
\renewcommand{\ps@plain}{
	\renewcommand{\@oddhead}{\hfill\thepage} % Número arriba a la derecha
...
\begin{document}
	...
	% Aquí empieza la numeración romana minúscula (i, ii, iii)
	\pagenumbering{roman}
	\renewcommand{\thepage}{\roman{page}}
	
	\sloppy
	% Hoja de calificaciones
	%\include{parte_inicial/hoja_calificaciones}
	% Licencia de uso
	%\include{parte_inicial/licencia_uso}
	% Dedicatoria
	...
	\include{parte_inicial/resumen.tex}
	\include{parte_inicial/abstract.tex}
