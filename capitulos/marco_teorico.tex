\chapter{MARCO TEÓRICO} 
	...
	\subsection{Actividades de la ingeniería de requerimientos}
		...
		\begin{figure}[h] % 'H' del paquete 'float' para mantener posición	
			...
			\vspace{0.3cm}
			\centering
			\includegraphics[width=0.65\textwidth]{imagenes/diagramas_casos_de_uso/venta-pasajes-casos-uso.png} % Inserta una imagen
			\vspace{0.3cm}
	...
	\subsection{Normalización}
		...
		\begin{figure}[!h] % 'H' del paquete 'float' para mantener posición	
			...
			\vspace{0.2cm}
			\centering
			\includegraphics[width=0.75\textwidth]{imagenes/normalizacion/2FN.png} % Inserta una imagen
			% \vspace{0.3cm}
			\vspace{-0.6cm}
		...
		\begin{figure}[!h] % 'H' del paquete 'float' para mantener posición	
			...
			\vspace{0.2cm}
			\centering
			\includegraphics[width=0.7\textwidth]{imagenes/normalizacion/3FN.png} % Inserta una imagen
			\vspace{0.3cm}
	...
	\subsection{Estructura jerárquica del modelo de calidad Boehm}
		...
		\begin{enumerate}[label=\textbf{\alph*)}, left=0cm, labelsep = 0.8cm, topsep = 0pt, parsep = 0pt] % Cambia el formato del inciso (a, b, c...)
